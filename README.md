...
/workspaces/MyMQL5_Project/            C:\...\MQL5\
...
[ Backtest / Logs ]
/mnt/mt5_tester/    <────────────────>  C:\...\Tester\

※ Windows 側の MQL5 フォルダは /mnt/mt5_mql5 に、
   Tester フォルダ（バックテスト結果・ログ）は /mnt/mt5_tester にマウントされています。
   sync.sh を実行すると、リポジトリ内の各フォルダが MT5 側の適切な
   サブディレクトリへ rsync されます。
```
